...
PhotoPath = "/Users/maxepstein/Dropbox/Art/experiments/IG_BOT/gallery_collection_01/021418/COMP_01/images"  # Change Directory to Folder with Pics that you want to upload
...
igapi = InstagramAPI("permanent.gallery.01", "icanCode69")
igapi.login()  # login
