...
PhotoPath = "/Users/maxepstein/Dropbox/Art/experiments/IG_BOT/gallery_collection_01/pollock/pollock/01"  # Change Directory to Folder with Pics that you want to upload
# Change to your Photo Hashtag
IGCaption = "02.15.2018\n #jacksonpollock#pollock#art#permanentgallery#modernart#instart#instaartists#abstractart#abstractexpressionism#abstractartist#abstractpainting"
...
igapi = InstagramAPI("permanent.pollock", "icanCode69")
igapi.login()  # login
